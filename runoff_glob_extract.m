function [my_latriv,my_lonriv,my_flow,my_rivername,number_river]=runoff_glob_extract01(grdfile,global_clim_river,MONTH);
...
%  Foundation.
%
%  This function was used to generate the river runoff for a specific 
%  month through the MONTH argument.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
warning on
FLOW_clm = zeros(12,length(ncriv{'FLOW_clm'}(1,:)));

for ii = 1:12

FLOW_clm(ii,:)=ncriv{'FLOW_clm'}(MONTH,:);   
end
close(ncriv)
%size(FLOW_clm)
%
